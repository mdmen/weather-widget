...
const areEqual = (prevProps, nextProps) =>
  prevProps.location.lastUpdate === nextProps.location.lastUpdate;

export const WidgetLocation: React.AbstractComponent<Props> = React.memo(
  ({ location }: Props): React.Node => {
    const {
      city,
      wind,
      humidity,
...
WidgetLocation.displayName = 'WidgetLocation';
